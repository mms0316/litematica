...
public class Hotkeys
{
    ...
    public static final ConfigHotkey MATERIAL_LIST_FETCH                = new ConfigHotkey("materialListFetch",                 "",     "Fetch materials required by the active Material List from opened container");
